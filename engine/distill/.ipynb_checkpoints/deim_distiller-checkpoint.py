...
class DEIMFGDDistiller(nn.Module):
    ...
    def load_teacher_checkpoint(self,
        ...
        missing_keys, unexpected_keys = self.teacher.load_state_dict(state_dict, strict=strict)
        if missing_keys:
    ...
    def load_student_checkpoint(self,
        ...
        missing_keys, unexpected_keys = self.student.load_state_dict(cleaned_state_dict, strict=strict)
